 ...
 */
class WordPressListService implements \WebAppick\WPListInfo\Interfaces\WordPressListInterface {
	...
	public function getTaxonomies() {
		...
		$taxonomies = get_taxonomies([
			'public' => true,  // Only include public taxonomies
		], 'names');  // Return taxonomy names instead of full objects
	...
	public function getPostTypes($args = []) {
		...
		return !empty($postTypes) ? $postTypes : [];
	}
	...
	public function getPostFormats() {
		...
		return !empty($postFormats) ? $postFormats : [];
	}
	...
	public function getPostMetas() {
		...
		return !empty($metaKeys) ? $metaKeys : [];
	}
